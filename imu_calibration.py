...
for fname in files:
    ...
    acc_data = np.loadtxt(fname, delimiter=',', skiprows=1, usecols=(2,3,4))
    gyro_data = np.loadtxt(fname, delimiter=',', skiprows=1, usecols=(5,6,7))
    mag_data = np.loadtxt(fname, delimiter=',', skiprows=1, usecols=(8,9,10))
